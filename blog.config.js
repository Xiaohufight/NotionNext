...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '4bd3d7fff84e417fada4bf13696e4214',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Augenstern', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一只技术菜鸟', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.augenstern.love', // 网站地址
